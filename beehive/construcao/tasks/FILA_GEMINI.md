...
> Atualizar a cada sessão após processar o inbox.
> Registrar cartucho ativo na seção de sessão ao abrir uma sessão.
...
| TOS-013 | PO | Branding Dinâmico — ideação e blueprint | BLUEPRINT_BRANDING_DINAMICO.md |
| TOS-019 | PO | Clientes demo — validação de nichos | debate-022 |
| DEBATE-022 | PO | Clientes demo apresentação | veredito emitido |
| DEBATE-020 | Coordenador | Documentação TenantOS — parecer | parecer emitido |
