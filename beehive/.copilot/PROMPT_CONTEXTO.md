...
## Pedido recomendado
"Copilot, rode `npm run squad:session:copilot`, leia `.hive-agent/session-state.env` e o inbox do dominio ativo. Se `NEXT_STEP` apontar para algum arquivo, leia so esse arquivo adicional e execute o proximo passo aprovado."
